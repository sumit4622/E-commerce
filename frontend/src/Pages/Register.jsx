...
export default function Register() {
    const [FormData, sethtmlFormData] = useState({
        email: "",
        password: "",
        confirmpassword: "",
    });
        ...
        <div>
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <a onClick={homepage_navigate} className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white text-teal-600 cursor-pointer">
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <htmlForm className="space-y-4 md:space-y-6" action="#">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="confirmpassword" value={FormData.confirmpassword} onChange={handleChange} id="confirm-password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
                                </div>
                                <Button
                                    type="submit"
                                    className="btn-teal">
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Already have an account? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={handleloginNviagte}>Sign In</a>
                                </p>
                            </htmlForm>
                        </div>
                    </div>
